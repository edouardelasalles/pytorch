...
TH_API void THTensor_(poisson_FloatTensor)(THTensor *self, THGenerator *_generator, THFloatTensor *lambda);
TH_API void THTensor_(poisson_DoubleTensor)(THTensor *self, THGenerator *_generator, THDoubleTensor *lambda);
