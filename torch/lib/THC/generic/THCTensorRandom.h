...
THC_API void THCTensor_(poisson)(struct THCState *state, THCTensor *self, double lambd);
THC_API void THCTensor_(poisson_FloatTensor)(struct THCState *state, THCTensor *self, THCudaTensor *lambd);
THC_API void THCTensor_(poisson_DoubleTensor)(struct THCState *state, THCTensor *self, THCudaDoubleTensor *lambd);
